...
namespace DbfImport
{
    public class DbfReaderHelper
    {

        #region DbfReaderHelper更新历史
        //-----------------------------------------------------------------------------------------------
        ...
        public class TDbfTable : IDisposable
        {
            ...
            private DbfReaderHelper _dbfHeader = null;
            ...
            private int GetFieldCount()
            {
                ...
                int fCount = (this._dbfHeader.HeaderLength - DbfReaderHelper.HeaderSize - 1) / TDbfField.FieldSize;

                for (int k = 0; k < fCount; k++)
                {
                    _fileStream.Seek(DbfReaderHelper.HeaderSize + k * TDbfField.FieldSize, SeekOrigin.Begin);  // 定位到每个字段结构区，获取第一个字节的值
            ...
            private void ReadFields()
            {
                ...
                try
                {
                    _fileStream.Seek(DbfReaderHelper.HeaderSize, SeekOrigin.Begin);
